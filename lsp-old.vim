...
let g:coc_disable_syntax_highlighting = 1
let g:lsp_textprop_enabled = 0
let g:lsp_diagnostics_signs_enabled = 0
let g:lsp_textprop_virtual_text_enabled =  0
let g:lsp_enabled = 1
...
augroup LspAutocommands
    autocmd!
    autocmd User lsp_buffer_enabled call s:CustomizeLspHighlight()
augroup END

" autocmd BufEnter * silent! CocRefresh

function! s:CustomizeLspHighlight()
    highlight! link CocWarningSign WarningMsg
    highlight! link CocWarningFloat WarningMsg
    highlight! link CocWarningLine Number

    highlight LspDiagnosticsError guibg=NONE ctermbg=NONE
    highlight LspDiagnosticsWarning guibg=NONE ctermbg=NONE
    ...
    sign define LspDiagnosticsSignError text=E texthl=LspDiagnosticsSignError
    sign define LspDiagnosticsSignWarning text=W texthl=LspDiagnosticsSignWarning
endfunction
...
inoremap <silent><expr> <C-W> coc#rpc#request('doHover', [])
